...
// Database hostname:
$config['dbConnection']['host'] = 'eacinstance.cmqbzqnyewvh.us-east-2.rds.amazonaws.com';
// Database username:
$config['dbConnection']['user'] = 'root';
// Database password:
$config['dbConnection']['pass'] = '11111111';
// Database name:
$config['dbConnection']['name'] = 'eac';
// Database type:
